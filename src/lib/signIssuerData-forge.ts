...
/**
 * Signs a issuerData and returns the signature.
 *
 ...
 * @param {string} issuerData - issuerData to sign
 * @returns {Buffer} - signature for given issuerData
 */
export function signIssuerData(
